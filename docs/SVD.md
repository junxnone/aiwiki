...
Update Date | `2022-03-14T04:31:38Z`
...
2 | $(A-\lambda I)x=0$  $\begin{vmatrix} 2-\lambda & 1 \\ 1 & 2-\lambda \\ \end{vmatrix} = 0$
3 |  $(2-\lambda)^2 - 1=0$ , $\lambda_{1}=1$, $\lambda_{2}=3$  $\lambda_{1}=1$, $\begin{bmatrix}  0 & 1 \\  1 & 1 \\  1 & 0 \\ \end{bmatrix}x=1x$ $\begin{bmatrix}  0 & 1 \\  1 & 1 \\  1 & 0 \\ \end{bmatrix}\begin{bmatrix} a_{1} \\ a_{2} \end{bmatrix}=\begin{bmatrix} a_{1} \\ a_{2} \end{bmatrix}$  $2a_{1} + a_{2} = a_{1}$, $a_{1} + 2a_{2} = a_{2}$ $\Rightarrow a_{1} + a_{2}=0$  $v_{1} = \begin{bmatrix} -\frac{1}{\sqrt{2}} \\ \frac{1}{\sqrt{2}} \end{bmatrix}$
