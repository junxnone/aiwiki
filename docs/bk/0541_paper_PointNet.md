...
<img width="1405" height="583" alt="Image" src="https://github.com/user-attachments/assets/893b8d7e-4a36-4760-b2a8-42542442e09e" />
...
| ------ | ------------------------ | ------------------------------------------------ | ----------- | ------------------------------- |
| 原始输入   | (4096, 3)                | 无（仅输入点云坐标）                                       | (4096, 3)   | N=4096，feat\_dim=3（xyz）         |
