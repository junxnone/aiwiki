...
**CVPR 2026**  
📄 [Paper](https://arxiv.org/abs/2512.11130) | 🌐 [Project
Page](https://nvlabs.github.io/Fast-FoundationStereo/) | 💻
...
**数据集发布:**
[nvidia/ffs\_stereo4d](https://huggingface.co/datasets/nvidia/ffs_stereo4d)
...
### 相关资源
  ...
  - 🌐 **项目主页**:
    [nvlabs.github.io](https://nvlabs.github.io/Fast-FoundationStereo/)
  - 📊 **数据集**: [Hugging
    Face](https://huggingface.co/datasets/nvidia/ffs_stereo4d)
