...
Update Date | `2022-04-07T02:41:08Z`
...
## 原理
- 因为物体的加入，成像点 D 产生了相位差: $\bigtriangleup \theta_{AC} = 2\pi \frac{AC}{T}$
  - T 为投射到参考平面的条纹周期
- 相似三角形  $\bigtriangleup ACD$ &  $\bigtriangleup CEI$ 推导: $\frac{h}{l} = \frac{AC}{CE} = \frac{AC}{AC+d}$
- 当 AC << d : $h = AC\frac{l}{d}$
-  $\bigtriangleup \theta_{AC} =  \frac{2\pi}{T}\frac{hd}{l}$
